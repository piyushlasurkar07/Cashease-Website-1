...
/*************** SUGGESTIONS LOGIC ***************/
/***************************************************
 * ADVANCED FINANCIAL SUGGESTION SYSTEM
 * ---------------------------------
 * Requirements:
 * expenses = [{ amount, category, date }]
 * goals = [{ name, amount, saved }]
 * limit = monthly budget limit (number)
 * streakCount = savings streak (number)
 * suggestionsList = UL / OL DOM element
 ***************************************************/
